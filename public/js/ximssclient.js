...
//        } else if(httpRequest.contentType != "text/xml") {                         // it always returns "text/plain"
                ...
                //меняем на лету доменное имя
                var matches = url.match( /^https?\:\/\/([^\/?#]+)(?:[\/?#]|$)/ );
                url = url.replace(matches[1], params.serverName);
                //console.log("Current url: "+url+" current serverName: "+params.serverName+" orig serverName: "+matches[1]);
                //\
