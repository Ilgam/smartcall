...
if (navigator.userAgent.indexOf('Bowser') === -1) {
    ...
    if (navigator.mozGetUserMedia) {
        ...
        webrtcDetectedVersion = (navigator.userAgent.match(/Firefox\/([0-9]+)\./) != null) ?
            parseInt(navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1], 10) : null;
        ...
        webrtcDetectedVersion = (navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./) != null) ?
            parseInt(navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)[2], 10) : null;
