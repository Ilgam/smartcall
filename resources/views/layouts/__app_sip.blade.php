...
<head>
    ...
    <script type="text/javascript" src="{{ URL::asset('js/ximssclient.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/ximsswrapper.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/adapter.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/callutils.js') }}"></script>
    <style type="text/css">
        .dn{
